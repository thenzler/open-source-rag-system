    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            **self._stats,
            ...
            'error_rate': self._stats['errors'] / max(self._stats['queries_executed'], 1),
            'pool': pool_stats
        }
...
class RedisConnectionPool:
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info(f"Redis connection pool initialized (max connections: {self.max_connections})")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            **self._stats,
            ...
            'error_rate': self._stats['errors'] / max(self._stats['commands_executed'], 1),
